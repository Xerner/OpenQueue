...
{
    [DbContext(typeof(OpenQueueDbContext))]
    [Migration("20241205202824_QueueItems_constraints")]
    partial class QueueItems_constraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenQueue.Models.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("OpenQueue.Models.Queues.Queue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppQueues", (string)null);
                });

            modelBuilder.Entity("OpenQueue.Models.Queues.QueueItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppQueueItems", (string)null);
                });
            ...
            modelBuilder.Entity("OpenQueue.Models.Queues.QueueItem", b =>
                {
                    b.HasOne("OpenQueue.Models.Queues.Queue", null)
                        .WithMany("QueueItems")
