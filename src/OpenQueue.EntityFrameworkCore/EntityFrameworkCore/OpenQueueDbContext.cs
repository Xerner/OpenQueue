...
public class OpenQueueDbContext :
    AbpDbContext<OpenQueueDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public OpenQueueDbContext(DbContextOptions<OpenQueueDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(OpenQueueConsts.DbTablePrefix + "Books",
        ...
        //{
        //    b.ToTable(OpenQueueConsts.DbTablePrefix + "YourEntities", OpenQueueConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
